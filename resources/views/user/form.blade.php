...
@section('usercontent')
    ...
    <form method="POST" action="{{ $route }}" class="user-form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group autogenerate-component">
                    <label>&nbsp;</label>
                    <div class="row">
                        <div class="col-md-4">
                            <span class="btn btn-primary" id="autogenerate">Generate</span>
                        </div>
                        <div class="col-md-8">
                            <input id="autogenerated-pass" readonly="readonly" class="form-control" >
                        </div>
                    </div>
                </div>
            </div>

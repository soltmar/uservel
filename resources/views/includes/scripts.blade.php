<script>
    ...
    $(document).ready(function () {
        ...
        $('.uservel .alert').delay(5000).fadeOut('slow');

        $('.autogenerate-component #autogenerate').on('click', function (){
            var pass = (Math.random() + 10).toString(36).substring(2,15) + (Math.random() + 10).toString(36).substring(2,15);
            $('.user-form #password').val(pass);
            $('.user-form #confirm-password').val(pass);
            $('.autogenerate-component #autogenerated-pass').val(pass).show();
        });
